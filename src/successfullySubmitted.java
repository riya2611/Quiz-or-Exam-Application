...
public class successfullySubmitted extends javax.swing.JFrame {
    ...
    public successfullySubmitted(String marks, int min, int sec) {
        initComponents();
        String marks1 = "Marks Obtained - " + marks;
        jLabel1.setText(marks1);
        String time = "Time Taken - " + min + " : " + sec;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 550, -1, -1));
        ...
        jLabel6.setText("Time Taken - 00 : 00");
        ...
        jLabel7.setText("Total Time - 10 : 00");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 340, -1, -1));
